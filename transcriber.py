    ...
    try:
        ...
        with yt_dlp.YoutubeDL(dl_opts) as ydl:
            try:
                ...
                return {"error": str(dl_err), "audio_server_path": None, "audio_relative_path": None}
...
def get_youtube_transcript_text(video_url):
    """Downloads the best subtitle (English or Romanian), parses it, and returns text."""
    ...
    try:
        ...
        if lang in subs:
            vtt_path = subs[lang].get('filepath')
        if not vtt_path:
